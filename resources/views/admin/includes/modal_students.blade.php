    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="form-horizontal" method="POST" action="/admin/students/add" enctype="multipart/form-data">
                    @csrf
                    <div class="card" style="width:100%;">
                        <div class="card-header bg-info">
                            <h3 class="card-title">Student Information & Details</h3>
                        </div>
                        <div class="card-body">

                            <p>Select a photo of the student.</p>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-xs-3">
                                    <img class="box-style" src="{{ url('storage/images/users/user.jpg') }}"
                                        id="student_photo" width="170px" height="150px">

                                </div>
                                <input type="file" placeholder="" class="file-chooser"
                                    onchange="document.getElementById('student_photo').src = window.URL.createObjectURL(this.files[0])"
                                    id="photo" name="photo" alt="Student Photo" required>
                            </div>
                            <p>Provide student's identification number.</p>
                            <div class="row">
                                <div class="col-sm-5">
                                    <div class="form-group">
                                        <label for="student_id" class="col-sm-12 control-label">LRN</label>
                                        <div class="col-xs-12">
                            ...
                            <p>Enter student's contacts number and email address.</p>
                            <div class="row">
...
<div class="modal fade" id="edit">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="form-horizontal" method="POST" action="/admin/students/edit"
                    ...
                    <div class="card" style="width:100%;">
                        ...
                        <div class="card-body">
                            ...
                            <p>Provide student's LRN.</p>
                            <div class="row">
                                <div class="col-sm-5">
                                    <div class="form-group">
                                        <label for="edit_student_id" class="col-sm-12 control-label">LRN</label>
                                        <div class="col-xs-12">
...
<div class="modal fade" id="addface">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">Student | Add Face</h4>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body">
                <form id="formAddface" class="form-horizontal" enctype="multipart/form-data" method="POST"
                    action="/admin/students/add-face">
                    @csrf
                    <input type="text" id="add_face_id" name="student_no">
                    <div class="row">
                        <div class="col-12">
                            <div class="form-group">
