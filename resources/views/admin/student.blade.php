...
@include('admin/includes/modal_students')
                                    ...
                                    <tbody>
                                        ...
                                        @foreach ($students as $index => $student)
                                            <tr>
                                                ...
                                                <td><img src="{{ url('storage/images/students/'. $student['photo']) }}"
                                                    alt="Student" class="brand-image img-circle elevation-3"
                                                ...
                                                <td>
                                                    <button type="button" class="btn btn-success btn-sm edit"
                                                        ...
                                                        data-status="{{ $student['stat_no'] }}"><i
                                                            class="fas fa-edit"></i> Edit</button>

                                                    <button type="button" class="btn bg-navy btn-sm addface"
                                                        data-id="{{ $student['student_id'] }}"><i
    ...
    <script>
        $(function() {
            ...
            $('#example1 tbody').on("click", ".delete", function() {
                ...
                var formAction = '/admin/students/delete/' + id;
