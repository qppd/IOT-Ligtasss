...
@include('admin/includes/modal_flood')
        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1>Flood Detection Modules</h1>
                        </div>
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                <li class="breadcrumb-item"><a href="{{ url('home') }}">Home</a></li>
                                <li class="breadcrumb-item active">Flood Detection Modules</li>
                            </ol>
                        </div>
                    </div>
                </div><!-- /.container-fluid -->
                            ...
                            <div class="card-body">
                                <table id="example2" class="table table-bordered table-striped">
                                    ...
                                    <tbody>
                                        ...
                                        @foreach ($floods as $index => $flood)
                                            <tr>
                                                <td>{{ $index + 1 }}</td>
                                                <td>{{ $flood['device_id'] }}</td>
                                                <td>{{ $flood['status'] }}</td>
                                                {{-- <td>{{ $gate['face_id'] }}</td> --}}
                                                {{-- <td>{{ $gate['status'] }}</td> --}}
                                                <td>
                                                    ...
                                                    <a href="/admin/flood/logs/{{ $flood['device_id'] }}"
                                                        class="btn btn-warning btn-sm"><i class="fas fa-list"></i>
                                                        Logs</a>

                                                    <button type="button" class="btn btn-danger btn-sm delete"
                                                        data-id="{{ $flood['id'] }}"><i class="fas fa-trash"></i>
                                                        Delete</button>
    ...
    <script>
        $(function() {
            ...
            $('#example2 tbody').on("click", ".delete", function() {
                ...
                var formAction = '/admin/flood/delete/' + id;
